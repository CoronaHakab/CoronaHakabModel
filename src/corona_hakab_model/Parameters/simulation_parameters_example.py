{
    ...
    "mild_end_to_pre_recovered_days": dist(1, 13, 23),
    ...
    "close_medical_care_to_mild_end_days": dist(8, 10, 12),
    ...
    "improving_to_mild_condition_end_days": dist(21, 42),
    ...
    "latent_to_asymptomatic_begin_prob": 0.3,
    "asymptomatic_begin_to_asymptomatic_end_prob": ...,
    "latent_to_pre_symptomatic_prob": ...,
    "pre_symptomatic_to_mild_condition_begin_prob": ...,
    "mild_condition_begin_to_mild_condition_end_prob": ...,
    "mild_end_to_close_medical_care_prob": 0.2375,
    "mild_end_to_need_icu_prob": 0.0324,
    "mild_end_to_pre_recovered_prob": ...,
    "close_medical_care_to_icu_prob": 0.26,
    "close_medical_care_to_mild_end_prob": ...,
    "need_icu_to_deceased_prob": 0.3,
    "need_icu_to_improving_prob": ...,
    "improving_to_need_icu_prob":0,
    "improving_to_pre_recovered_prob": ...,
    "improving_to_mild_condition_end_prob": 0,
    "pre_recovered_to_recovered_prob": ...,
    "asymptomatic_end_to_recovered_prob": ...,
    # infections ratios, See bucket dict for more info on how to use.
    "pre_symptomatic_infection_ratio": BucketDict({10: 1}),  # x <= 10 then key is 10,
