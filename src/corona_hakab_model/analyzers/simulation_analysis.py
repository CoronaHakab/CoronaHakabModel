...
def plot_aggregations_from_csv(csv_file_path, aggregation_funcs: Dict[str, Callable]):
    ...
    :param aggregation_funcs: dict of all the aggregation functions that want to be applied per columns
    :return: return None and plot a matplotlib bar-chart
    """
...
def plot_parameter_propagation_aggregated(mean_df: pd.DataFrame, std_df: pd.DataFrame,
    ...
    :param mean_df: a DataFrame containing al the means of the parameters across some simulation runs
    :param std_df: a DataFrame containing al the stds of the parameters across some simulation runs
    :param parameter_names: possible to pass list of all the parameter names to plot, if not given plot all parameters
    :return:
    """
    ...
    if len(parameter_names) == 0:
        ...
        print(f"non of given parameter exsist plotting for the first parameter - {parameter_names[0]}")
